...
public final class Controllers {
    ...
    public static class RestaurantController {
        ...
        public ResponseEntity<List<Api.MenuItemResponse>> menu(@PathVariable Long id) {
            ...
            // Lesson 006: up to lesson 005 each getTags() call below issued its own SELECT,
            // because tags are a lazy collection. findByRestaurantId now loads them with the
            // items (see MenuItemRepository), so this loop no longer touches the database.
