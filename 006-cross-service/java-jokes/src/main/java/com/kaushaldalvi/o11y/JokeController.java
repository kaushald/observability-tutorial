...
public class JokeController {
    ...
    public String index() {
        ...
        Runnable runnable = this::someOtherMethod;
    ...
    private void someOtherMethod() {
        ...
        try (Scope scope = span.makeCurrent()) {
            ...
            span.setAttribute("someKey", "some value");
            Thread.sleep(generator.nextInt(250));
            span.addEvent("first event", Attributes.of(AttributeKey.stringKey("eventKey"), "event details"));
